export const faqs = [
  ...
  },
  {
    ...
    desc: "Bursa çekici hizmetimiz kapsamında otomobil, hafif ticari araç, motosiklet, scooter, minibüs ve kamyonet gibi birçok aracı taşıyoruz. Ağır tonajlı araçlar için özel çekici ekipmanlarımız mevcuttur.",
  },
  {
    title: "Oto kurtarma ve çekici hizmeti ücretleri nasıl hesaplanıyor?",
    desc: "Bursa oto kurtarma fiyatları; aracın tipi, alınan mesafe ve hizmet türüne göre belirlenmektedir. Ücretlendirme genellikle sabit bir başlangıç fiyatı + km başına hesaplanır. Tüm fiyat bilgilerini şeffaf şekilde önceden bildiriyoruz.",
  },
  {
